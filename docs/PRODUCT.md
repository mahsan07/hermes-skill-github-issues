...
Github Issues is a focused, shareable agent workflow.

## What it does

Create, triage, label, and assign GitHub issues through guarded gh or REST workflows. Use when the user explicitly requests this capability or a closely related task.
