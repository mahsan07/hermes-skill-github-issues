<p align="center">
  <img src="assets/system-map.svg" alt="Detailed system map for GitHub Issues" width="100%">
</p>
...
Tool integrations can create accidental side effects when authentication, scope, preview, execution, and verification are not separated. **GitHub Issues** turns that work into an explicit sequence with visible inputs, outputs, review points, and completion evidence.

## Why the repository has this name

The shared `hermes-skill-` prefix identifies this as a portable Hermes workflow package. `github-issues` names the capability directly—github issues—so the repository remains searchable and understandable outside the original AI-OS workspace. The public title is **GitHub Issues**.
...
| What does it do? | Create, triage, label, and assign GitHub issues through guarded gh or REST workflows. |
...
![GitHub Issues system map](assets/system-map.svg)

## Operation sequence

![GitHub Issues actor and data sequence](assets/operation-sequence.svg)
...
![Illustrative output produced by GitHub Issues](assets/example-output.svg)
...
> In a disposable test workspace, create, triage, label, and assign GitHub issues through guarded gh or REST workflows. Return the result, the evidence used to verify it, and any limitations or actions that still require approval.
